...
potential_myo_sub <- subset(combined_no_rbc, idents = c("FB","SMC"))
potential_myo_sub
...
After discussion with Shoval Cthrc1 seems to be the most reliable marker to differentiate the myofibroblasts they are in cluster 3,6, 13 and 17
...
```{r}
potential_myo_sub@meta.data$myofib_clusters[potential_myo_sub@meta.data$integrated_snn_res.1.5==4|potential_myo_sub@meta.data$integrated_snn_res.1.5==13|potential_myo_sub@meta.data$integrated_snn_res.1.5==17|potential_myo_sub@meta.data$integrated_snn_res.1.5==6|potential_myo_sub@meta.data$integrated_snn_res.1.5==8] <- "Myofibroblasts"
...
DotPlot(combined_no_rbc, features = c("Cthrc1"))
FeaturePlot(combined_no_rbc, features = c("Cthrc1"))
DimPlot(combined_no_rbc, reduction = "umap", label = TRUE, group.by = "myofib_clusters")
```
```{r}
VlnPlot(object = combined_no_rbc, features = c(genes_fig1D, "Cthrc1"), stack = TRUE) + NoLegend()
```
